        ...
        <td colspan="2" align="left" class="tdContentTableForms">
			<table class="defaultTable">
				...
				<tr>
					...
					<td nowrap="nowrap" colspan="2"><html:text property="member(user).username" maxlength="${accessSettings.usernameLength.max}" readonly="true" styleClass="medium InputBoxDisabled required"/></td>
				</tr>
				<tr>
