...
<table class="defaultTable">
	...
	<tr>
		...
		<td colspan="2" nowrap="nowrap"><html:text property="admin(user).username" maxlength="${accessSettings.usernameLength.max}" readonly="true" styleClass="medium InputBoxDisabled required"/></td>
	</tr>
	<tr>
