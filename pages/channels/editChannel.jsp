...
<script>
	...
	<c:forEach var="entry" items="${possiblePrincipalTypes}">
		{
			var obj = {value: '<cyclos:escapeJS>${entry.key}</cyclos:escapeJS>', text: '<cyclos:escapeJS>${entry.value}</cyclos:escapeJS>', selected: ${cyclos:contains(selectedPrincipalTypes, entry.key)} };
